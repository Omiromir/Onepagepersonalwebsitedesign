...
export function Contacts() {
  ...
  return (
    <section id="contacts" className="py-16 md:py-20 lg:py-24 bg-accent/30" ref={ref as any}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="space-y-3">
              <motion.a
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
                transition={{ duration: 0.5, delay: 0.2, ease: [0.21, 0.45, 0.27, 0.9] }}
              ...
              <motion.a
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
                transition={{ duration: 0.5, delay: 0.3, ease: [0.21, 0.45, 0.27, 0.9] }}
                whileHover={{ x: 4, transition: { duration: 0.2 } }}
                className="flex items-center gap-3 p-4 rounded-xl border border-border hover:bg-card transition-all duration-200 group"
              >
              ...
              <motion.a
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
                transition={{ duration: 0.5, delay: 0.4, ease: [0.21, 0.45, 0.27, 0.9] }}
                whileHover={{ x: 4, transition: { duration: 0.2 } }}
                className="flex items-center gap-3 p-4 rounded-xl border border-border hover:bg-card transition-all duration-200 group"
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[13px] text-foreground/60">contact@example.com</div>
                </div>
              </motion.a>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-card border border-border rounded-2xl p-6 md:p-8">
              <h3 className="text-[18px] font-semibold mb-6">Отправить сообщение</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {/* Contact */}
                <div>
                  <label htmlFor="contact" className="block text-[14px] font-medium mb-2">
                ...
                {/* Topic */}
                <div>
                  <label htmlFor="topic" className="block text-[14px] font-medium mb-2">
